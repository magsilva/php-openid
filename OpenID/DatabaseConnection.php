...
/**
 * The OpenID_DatabaseConnection class, which is used to emulate
 ...
 * abstraction mechanisms.  See {@link OpenID_SQLStore} for more
 ...
 * connection.  Any subclass of OpenID_DatabaseConnection MUST
 * adhere to the interface specified here.
 *
 * @package OpenID
 */
class OpenID_DatabaseConnection {
    /**
